...
REPO_BASE_HTTPS = "https://github.com/CNTRPRTY/{}.git"
...
REPOS_FULL = REPOS_BASE + ['armory-utxsvr', 'xcp-proxy', 'http-addrindexrs']
...
HOST_PORTS_USED = {
    ...
    # TODO some full ports might not be needed (were from counterblock/counterwallet/mongodb)
    'full': [8332, 18332, 8432, 18432, 4000, 14000, 4100, 14100, 80, 443, 27017, 8098, 18098]
}
VOLUMES_USED = {
    ...
    'full': ['bitcoin-data', 'addrindexrs-data', 'counterparty-data', 'armory-data', 'xcp-proxy']
...
SHELL_CHOICES = UPDATE_CHOICES + ['redis', 'bitcoin', 'bitcoin-testnet', 'addrindexrs', 'addrindexrs-testnet']
